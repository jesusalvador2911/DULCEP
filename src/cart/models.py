...
class FlavourVariation(models.Model):
...
class Product(models.Model):
    ...
    available_flavours = models.ManyToManyField(FlavourVariation)
...
class OrderItem(models.Model):
    ...
    flavour = models.ForeignKey(FlavourVariation, on_delete=models.CASCADE)
