# Generated by Django 3.0.8 on 2022-05-03 02:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_flavours', models.ManyToManyField(to='cart.FlavourVariation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flavour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.FlavourVariation')),
